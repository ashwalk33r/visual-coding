...
export type DrawCardsOptions = [count: number | number[], sketch: P5, width: number, y: number, color: string, padding: number, offset: number, flatness: number, texture?: [Image, Image]];
